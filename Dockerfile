...
ENV JAVA_VERSION=8.121.13-r0 \
    JNLP_VERSION=2.62 \
    GCLOUDSDK_VERSION=157.0.0 \
    KUBECTL_VERSION=1.5.2 \
    BZR_VERSION=2.7.0-r0 \
    GIT_VERSION=2.11.2-r0 \
...
LABEL "maintainer"="cloudsquad@fxinnovation.com" \
      ...
      "org.label-schema.applications.aha.version"=$AHA_VERSION \
