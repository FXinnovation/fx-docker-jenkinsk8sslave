...
ENV BASH_VERSION=5.1.4-r0 \
    ...
    E2FSPROGS_VERSION=1.46.2-r0 \
    GIT_VERSION=2.32.0-r0 \
    GROFF_VERSION=1.22.4-r1 \
    IPTABLES_VERSION=1.8.7-r1 \
    JAVA_VERSION=8.282.08-r1 \
    MERCURIAL_VERSION=5.7-r0 \
    JQ_VERSION=1.6-r1 \
    OPENSSH_VERSION=8.6_p1-r2 \
    PROCPS_VERSION=3.3.17-r0 \
    PY3PIP_VERSION=20.3.4-r0 \
    PYTHON3_VERSION=3.8.10-r0 \
    SUBVERSION_VERSION=1.14.1-r0 \
