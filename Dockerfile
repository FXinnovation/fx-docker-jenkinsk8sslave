...
ENV BASH_VERSION=5.0.0-r0 \
    ...
    E2FSPROGS_VERSION=1.45.2-r0 \
    GIT_VERSION=2.22.0-r0 \
    GROFF_VERSION=1.22.4-r0 \
    IPTABLES_VERSION=1.8.3-r0 \
    JAVA_VERSION=8.212.04-r0 \
    MERCURIAL_VERSION=4.9.1-r0 \
    JQ_VERSION=1.6-r0 \
    OPENSSH_VERSION=8.0_p1-r0 \
    PROCPS_VERSION=3.3.15-r0 \
    PY2PIP_VERSION=18.1-r0 \
    PYTHON2_VERSION=2.7.16-r1 \
    SUBVERSION_VERSION=1.12.0-r0 \
